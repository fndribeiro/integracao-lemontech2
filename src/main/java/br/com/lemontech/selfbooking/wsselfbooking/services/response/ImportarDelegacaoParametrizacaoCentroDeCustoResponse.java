/**
 * ImportarDelegacaoParametrizacaoCentroDeCustoResponse.java
 *
...
public class ImportarDelegacaoParametrizacaoCentroDeCustoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public ImportarDelegacaoParametrizacaoCentroDeCustoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this ImportarDelegacaoParametrizacaoCentroDeCustoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this ImportarDelegacaoParametrizacaoCentroDeCustoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ImportarDelegacaoParametrizacaoCentroDeCustoResponse)) return false;
        ImportarDelegacaoParametrizacaoCentroDeCustoResponse other = (ImportarDelegacaoParametrizacaoCentroDeCustoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ImportarDelegacaoParametrizacaoCentroDeCustoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "importarDelegacaoParametrizacaoCentroDeCustoResponse"));
