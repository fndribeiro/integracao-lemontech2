/**
 * CadastrarUnidadeNegocioResponse.java
 *
...
public class CadastrarUnidadeNegocioResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarUnidadeNegocioResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarUnidadeNegocioResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarUnidadeNegocioResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarUnidadeNegocioResponse)) return false;
        CadastrarUnidadeNegocioResponse other = (CadastrarUnidadeNegocioResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarUnidadeNegocioResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarUnidadeNegocioResponse"));
