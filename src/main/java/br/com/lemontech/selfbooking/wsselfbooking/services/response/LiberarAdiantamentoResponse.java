/**
 * LiberarAdiantamentoResponse.java
 *
...
public class LiberarAdiantamentoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public LiberarAdiantamentoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this LiberarAdiantamentoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this LiberarAdiantamentoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof LiberarAdiantamentoResponse)) return false;
        LiberarAdiantamentoResponse other = (LiberarAdiantamentoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(LiberarAdiantamentoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "liberarAdiantamentoResponse"));
