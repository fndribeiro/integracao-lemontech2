/**
 * DeletarParticipanteTreinamentoResponse.java
 *
...
public class DeletarParticipanteTreinamentoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public DeletarParticipanteTreinamentoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this DeletarParticipanteTreinamentoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this DeletarParticipanteTreinamentoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeletarParticipanteTreinamentoResponse)) return false;
        DeletarParticipanteTreinamentoResponse other = (DeletarParticipanteTreinamentoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeletarParticipanteTreinamentoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "deletarParticipanteTreinamentoResponse"));
