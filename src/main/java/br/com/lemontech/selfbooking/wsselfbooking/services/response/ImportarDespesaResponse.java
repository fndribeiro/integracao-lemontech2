...
public class ImportarDespesaResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public ImportarDespesaResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this ImportarDespesaResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this ImportarDespesaResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ImportarDespesaResponse)) return false;
        ImportarDespesaResponse other = (ImportarDespesaResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ImportarDespesaResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "importarDespesaResponse"));
