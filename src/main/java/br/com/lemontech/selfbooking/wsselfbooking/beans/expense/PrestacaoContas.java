...
public class PrestacaoContas  implements java.io.Serializable {
    ...
    private br.com.lemontech.selfbooking.wsselfbooking.beans.expense.Fluxo[] fluxos;
    ...
    public PrestacaoContas(
           ...
           br.com.lemontech.selfbooking.wsselfbooking.beans.expense.Fluxo[] fluxos) {
           this.id = id;
    ...
    /**
     * Gets the fluxos value for this PrestacaoContas.
     * 
     * @return fluxos
     */
    public br.com.lemontech.selfbooking.wsselfbooking.beans.expense.Fluxo[] getFluxos() {
        return fluxos;
    }


    /**
     * Sets the fluxos value for this PrestacaoContas.
     * 
     * @param fluxos
     */
    public void setFluxos(br.com.lemontech.selfbooking.wsselfbooking.beans.expense.Fluxo[] fluxos) {
        this.fluxos = fluxos;
    }
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        ...
        _equals = true && 
            ...
            this.reembolso == other.isReembolso() &&
            ...
            ((this.fluxos==null && other.getFluxos()==null) || 
             (this.fluxos!=null &&
              java.util.Arrays.equals(this.fluxos, other.getFluxos())));
        __equalsCalc = null;
        return _equals;
    }
    ...
    public synchronized int hashCode() {
        ...
        _hashCode += (isReembolso() ? Boolean.TRUE : Boolean.FALSE).hashCode();
        if (getItens() != null) {
            for (int i=0;
        ...
        if (getFluxos() != null) {
            for (int i=0;
                 i<java.lang.reflect.Array.getLength(getFluxos());
                 i++) {
                java.lang.Object obj = java.lang.reflect.Array.get(getFluxos(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
    ...
    static {
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/beans/expense", "fluxo"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setItemQName(new javax.xml.namespace.QName("", "fluxo"));
        typeDesc.addFieldDesc(elemField);
    }
