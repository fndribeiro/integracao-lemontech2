/**
 * CadastrarParticipanteTreinamentoResponse.java
 *
...
public class CadastrarParticipanteTreinamentoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarParticipanteTreinamentoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarParticipanteTreinamentoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarParticipanteTreinamentoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarParticipanteTreinamentoResponse)) return false;
        CadastrarParticipanteTreinamentoResponse other = (CadastrarParticipanteTreinamentoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarParticipanteTreinamentoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarParticipanteTreinamentoResponse"));
