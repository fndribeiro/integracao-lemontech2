/**
 * CadastrarControleClienteResponse.java
 *
...
public class CadastrarControleClienteResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarControleClienteResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarControleClienteResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarControleClienteResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarControleClienteResponse)) return false;
        CadastrarControleClienteResponse other = (CadastrarControleClienteResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarControleClienteResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarControleClienteResponse"));
