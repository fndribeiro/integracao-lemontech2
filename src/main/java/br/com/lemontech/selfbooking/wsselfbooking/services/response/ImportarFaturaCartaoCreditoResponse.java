/**
 * ImportarFaturaCartaoCreditoResponse.java
 *
...
public class ImportarFaturaCartaoCreditoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public ImportarFaturaCartaoCreditoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this ImportarFaturaCartaoCreditoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this ImportarFaturaCartaoCreditoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ImportarFaturaCartaoCreditoResponse)) return false;
        ImportarFaturaCartaoCreditoResponse other = (ImportarFaturaCartaoCreditoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ImportarFaturaCartaoCreditoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "importarFaturaCartaoCreditoResponse"));
