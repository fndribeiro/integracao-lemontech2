...
public class PresacaoContasStatus implements java.io.Serializable {
    ...
    public static final java.lang.String _RETORNOU_SOLICITANTE = "RETORNOU_SOLICITANTE";
    public static final java.lang.String _REDIRECIONADA = "REDIRECIONADA";
    public static final java.lang.String _ITEM_ESTORNADO = "ITEM_ESTORNADO";
    ...
    public static final PresacaoContasStatus CANCELADO = new PresacaoContasStatus(_CANCELADO);
    public static final PresacaoContasStatus RETORNOU_SOLICITANTE = new PresacaoContasStatus(_RETORNOU_SOLICITANTE);
    public static final PresacaoContasStatus REDIRECIONADA = new PresacaoContasStatus(_REDIRECIONADA);
    public static final PresacaoContasStatus ITEM_ESTORNADO = new PresacaoContasStatus(_ITEM_ESTORNADO);
