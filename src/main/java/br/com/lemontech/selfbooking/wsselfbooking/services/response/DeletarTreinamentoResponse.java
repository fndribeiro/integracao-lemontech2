/**
 * DeletarTreinamentoResponse.java
 *
...
public class DeletarTreinamentoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public DeletarTreinamentoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this DeletarTreinamentoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this DeletarTreinamentoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof DeletarTreinamentoResponse)) return false;
        DeletarTreinamentoResponse other = (DeletarTreinamentoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(DeletarTreinamentoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "deletarTreinamentoResponse"));
