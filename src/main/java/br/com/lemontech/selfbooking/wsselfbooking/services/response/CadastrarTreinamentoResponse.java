/**
 * CadastrarTreinamentoResponse.java
 *
...
public class CadastrarTreinamentoResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public CadastrarTreinamentoResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this CadastrarTreinamentoResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this CadastrarTreinamentoResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CadastrarTreinamentoResponse)) return false;
        CadastrarTreinamentoResponse other = (CadastrarTreinamentoResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CadastrarTreinamentoResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "cadastrarTreinamentoResponse"));
