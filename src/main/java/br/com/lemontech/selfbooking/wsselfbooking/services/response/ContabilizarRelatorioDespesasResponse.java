/**
 * ContabilizarRelatorioDespesasResponse.java
 *
...
public class ContabilizarRelatorioDespesasResponse  implements java.io.Serializable {
    private br.com.lemontech.selfbooking.wsselfbooking.beans.types.ResultadoOperacao resultadoOperacao;

    public ContabilizarRelatorioDespesasResponse() {
    }
    ...
    /**
     * Gets the resultadoOperacao value for this ContabilizarRelatorioDespesasResponse.
     * 
    ...
    /**
     * Sets the resultadoOperacao value for this ContabilizarRelatorioDespesasResponse.
     * 
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ContabilizarRelatorioDespesasResponse)) return false;
        ContabilizarRelatorioDespesasResponse other = (ContabilizarRelatorioDespesasResponse) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ContabilizarRelatorioDespesasResponse.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://lemontech.com.br/selfbooking/wsselfbooking/services/response", "contabilizarRelatorioDespesasResponse"));
